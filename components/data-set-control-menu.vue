<template>
  <panel class="data-set-control-menu">
    <span class="data-set-control-menu__title h4 unselectable">{{ themeName }}</span>
    <ul class="data-set-control-menu__list">
      <li v-for="dataset in datasets" :key="dataset.id" class="data-set-control-menu__list-item">
        <div id="menu-control">
          <label class="data-set-control-menu__label">
            ...
            >
              <icon class="data-set-control-menu__icon" :name="`dataset-${dataset.id}`" />
            </ui-tooltip>
            <icon v-else class="data-set-control-menu__icon" :name="`dataset-${dataset.id}`" />
        ...
        <div v-if="getActiveRasterLayer === dataset.id" class="default-layout__legend">
          <layer-legend id="layer-legend" />
          <div id="units">
            {{ ` [${dataset.units}]` }}
          </div>
        </div>
